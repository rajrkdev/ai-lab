  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 12 }}>
        <div style={{ fontSize: 12, fontWeight: 700, color: "#d1d5db", marginBottom: 8 }}>All 8 Hook Events</div>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 }}>
          {[
            ...
            <div key={i} style={{ padding: 8, background: "#1e231e", borderRadius: 8, border: "1px solid rgba(255,255,255,0.14)" }}>
              <div style={{ fontSize: 11, fontWeight: 700, color: h.color }}>{h.name}</div>
              <div style={{ fontSize: 10, color: "#9b9895", marginTop: 3 }}>{h.desc}</div>
            </div>
          ))}
        </div>
      </div>
