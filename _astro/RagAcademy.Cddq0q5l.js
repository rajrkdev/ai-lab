...
# Production target: ~0.94 retrieval accuracy`}),e.jsxs(d,{type:"key",children:[e.jsx("strong",{children:"Debugging low scores:"})," Low faithfulness → LLM hallucinating, tighten system prompt. Low context recall → chunking too fine, or wrong embedding model. Low context precision → reranker threshold too low, or k too high."]})]}),q={foundations:A,chunking:W,embeddings:z,hybrid:P,advanced:C,agentic:B,evaluation:E};function H(){const[t,o]=x.useState(0),[r,i]=x.useState(new Set),h=c[t],m=q[h.content],s=l=>{const n=t+l;n>=0&&n<c.length&&(i(a=>new Set([...a,t])),o(n))};return e.jsxs("div",{style:{display:"flex",height:"100vh",background:"#010409",fontFamily:"'Segoe UI', system-ui, sans-serif",color:"#c9d1d9",overflow:"hidden"},children:[e.jsxs("div",{style:{width:260,background:"#0d1117",borderRight:"1px solid #21262d",display:"flex",flexDirection:"column",flexShrink:0,overflowY:"auto"},children:[e.jsxs("div",{style:{padding:"20px 16px",borderBottom:"1px solid #21262d"},children:[e.jsx("div",{style:{color:"#ffffff",fontWeight:800,fontSize:16,letterSpacing:-.5},children:"RAG Academy"}),e.jsx("div",{style:{color:"#8b949e",fontSize:12,marginTop:2},children:"From Scratch → Production"}),e.jsx("div",{style:{marginTop:10,background:"#161b22",borderRadius:4,height:4,overflow:"hidden"},children:e.jsx("div",{style:{background:h.color,height:"100%",width:`${r.size/c.length*100}%`,transition:"width 0.5s",borderRadius:4}})}),e.jsxs("div",{style:{color:"#8b949e",fontSize:11,marginTop:4},children:[r.size,"/",c.length," modules completed"]})]}),e.jsx("div",{style:{flex:1,padding:"8px 8px"},children:c.map((l,n)=>{const a=t===n,p=r.has(n);return e.jsx("div",{onClick:()=>o(n),style:{padding:"10px 12px",borderRadius:8,marginBottom:2,cursor:"pointer",background:a?`${l.color}18`:"transparent",border:a?`1px solid ${l.color}44`:"1px solid transparent",transition:"all 0.15s"},children:e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[e.jsx("span",{style:{fontSize:16},children:p&&!a?"✅":l.emoji}),e.jsxs("div",{children:[e.jsx("div",{style:{color:a?l.color:"#c9d1d9",fontSize:13,fontWeight:a?700:400},children:l.title}),e.jsx("div",{style:{color:"#8b949e",fontSize:11},children:l.subtitle})]})]})},n)})})]}),e.jsxs("div",{style:{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"},children:[e.jsxs("div",{style:{padding:"16px 24px",borderBottom:"1px solid #21262d",background:"#0d1117",display:"flex",alignItems:"center",gap:12,flexShrink:0},children:[e.jsx("span",{style:{fontSize:24},children:h.emoji}),e.jsxs("div",{children:[e.jsxs("div",{style:{color:h.color,fontWeight:700,fontSize:16},children:["Module ",t+1," / ",c.length]}),e.jsx("div",{style:{color:"#8b949e",fontSize:12},children:h.subtitle})]})]}),e.jsxs("div",{style:{flex:1,overflowY:"auto",padding:"24px 32px",maxWidth:900},children:[e.jsx(m,{}),e.jsxs("div",{style:{display:"flex",gap:12,marginTop:32,paddingTop:16,borderTop:"1px solid #21262d"},children:[t>0&&e.jsx("button",{onClick:()=>s(-1),style:{background:"#161b22",border:"1px solid #30363d",color:"#c9d1d9",padding:"8px 20px",borderRadius:8,cursor:"pointer",fontSize:14},children:"← Previous"}),t<c.length-1&&e.jsx("button",{onClick:()=>s(1),style:{background:h.color,border:"none",color:"#000",padding:"8px 20px",borderRadius:8,cursor:"pointer",fontSize:14,fontWeight:700,marginLeft:"auto"},children:"Next Module →"}),t===c.length-1&&e.jsx("button",{onClick:()=>{i(new Set(c.map((l,n)=>n)))},style:{background:"#00ff9d",border:"none",color:"#000",padding:"8px 20px",borderRadius:8,cursor:"pointer",fontSize:14,fontWeight:700,marginLeft:"auto"},children:"🎓 Complete Course!"})]})]})]})]})}export{H as default};
