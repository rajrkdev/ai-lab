import{j as e}from"./jsx-runtime.u17CrQMm.js";import{r as c}from"./index.B02hbnpo.js";const h=[{id:"d2",label:"D2: Tool Design & MCP",color:"#10B981"},{id:"d3",label:"D3: Claude Code Config",color:"#F59E0B"},{id:"d4",label:"D4: Prompt & Output",color:"#8B5CF6"},{id:"d5",label:"D5: Context & Reliability",color:"#EF4444"}];function r({children:i}){return e.jsx("pre",{style:{background:"#1E293B",color:"#A5F3FC",borderRadius:8,padding:12,fontSize:11.5,lineHeight:1.5,overflow:"auto",margin:"8px 0"},children:i})}function s({type:i,children:n}){const a={exam:{bg:"#FEF3C7",b:"#F59E0B",l:"🎯 EXAM"},key:{bg:"#EBF5FF",b:"#3B82F6",l:"💡 KEY"},correct:{bg:"#F0FDF4",b:"#22C55E",l:"✅"},wrong:{bg:"#FEF2F2",b:"#EF4444",l:"❌"},warn:{bg:"#FFF7ED",b:"#F97316",l:"⚠️"}}[i]||{bg:"#F8FAFC",b:"#64748B",l:"📌"};return e.jsxs("div",{style:{padding:12,background:a.bg,borderLeft:`4px solid ${a.b}`,borderRadius:"0 8px 8px 0",marginBottom:10,fontSize:13,lineHeight:1.6,color:"#334155"},children:[e.jsxs("span",{style:{fontSize:11,fontWeight:700,color:a.b},children:[a.l," "]}),n]})}function d({items:i,active:n,onSelect:a}){return e.jsx("div",{style:{display:"flex",gap:4,marginBottom:12,flexWrap:"wrap"},children:i.map((t,o)=>e.jsx("button",{onClick:()=>a(o),style:{padding:"5px 10px",borderRadius:6,fontSize:11,fontWeight:600,cursor:"pointer",border:`2px solid ${n===o?t.color||"#3B82F6":"#E2E8F0"}`,background:n===o?(t.color||"#3B82F6")+"15":"white",color:n===o?t.color||"#1E40AF":"#64748B"},children:t.label},o))})}function l({left:i,right:n}){return e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:12},children:[e.jsxs("div",{style:{padding:12,background:"#FEF2F2",borderRadius:10,border:"1px solid #FECACA"},children:[e.jsx("div",{style:{fontSize:12,fontWeight:700,color:"#991B1B",marginBottom:6},children:i.title}),i.content]}),e.jsxs("div",{style:{padding:12,background:"#F0FDF4",borderRadius:10,border:"1px solid #BBF7D0"},children:[e.jsx("div",{style:{fontSize:12,fontWeight:700,color:"#166534",marginBottom:6},children:n.title}),n.content]})]})}function u(){const[i,n]=c.useState(0),a=[{label:"📝 Descriptions",color:"#10B981"},{label:"⚠️ isError Flag",color:"#EF4444"},{label:"🎯 tool_choice",color:"#3B82F6"},{label:"⚙️ MCP Config",color:"#F59E0B"},{label:"🔧 Built-in Tools",color:"#8B5CF6"}];return e.jsxs("div",{children:[e.jsx(d,{items:a,active:i,onSelect:n}),i===0&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"Tool Descriptions = #1 Selection Mechanism"}),e.jsx(l,{left:{title:"❌ Minimal Descriptions",content:e.jsx(r,{children:`get_customer:
...
AFTER (three specific tools):
  ...
  verify_claim_against_source → Checks claims vs source`}),e.jsx(s,{type:"warn",children:`System prompt keyword-sensitive instructions can override well-written tool descriptions. If your system prompt says "when user mentions 'order', always use search_tool" — it may override get_customer even when that's the right tool. Review system prompts for unintended keyword associations.`})]}),i===1&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"MCP isError Flag — Critical Distinction"}),e.jsx(s,{type:"key",children:"Two types of MCP errors exist. Protocol-level errors (JSON-RPC error field) are NOT visible to the LLM. Tool execution errors (isError: true in result) ARE visible to the LLM, enabling self-correction."}),e.jsx(l,{left:{title:"🔴 Access Failure (isError: true)",content:e.jsxs("div",{children:[e.jsx(r,{children:`{
  "content": [{
    "type": "text",
...
}`}),e.jsx("h4",{style:{fontSize:13,fontWeight:600,color:"#EF4444",marginTop:12},children:"Three Error Anti-Patterns"}),e.jsx("div",{style:{display:"grid",gap:6},children:[{pattern:"Generic 'Operation failed'",why:"Hides context — agent can't make recovery decisions"},{pattern:"Suppressing errors as success (empty result + isError: false)",why:"Agent thinks search worked but found nothing, when actually search didn't complete"},{pattern:"Terminating entire workflow on single failure",why:"One subagent timeout shouldn't kill a 5-agent pipeline. Wastes partial results."}].map((t,o)=>e.jsxs("div",{style:{padding:8,background:"#FEF2F2",borderRadius:6,border:"1px solid #FECACA"},children:[e.jsxs("span",{style:{fontSize:12,fontWeight:600,color:"#991B1B"},children:["❌ ",t.pattern]}),e.jsx("div",{style:{fontSize:11,color:"#7F1D1D",marginTop:2},children:t.why})]},o))}),e.jsx(s,{type:"exam",children:"Local recovery within subagents: Subagents should retry transient errors locally (exponential backoff). Only propagate to coordinator errors they cannot resolve — include failure type, what was attempted, partial results, and alternative approaches."})]}),i===2&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"tool_choice Options — Complete Reference"}),e.jsx("div",{style:{display:"grid",gap:8},children:[{opt:'"auto"',icon:"🤔",desc:"Claude decides freely — may or may not call a tool",when:"Default for most agentic loops. Conversational + tool use mixed.",color:"#64748B",code:'tool_choice={"type": "auto"}  # Default'},{opt:'"any"',icon:"🎯",desc:"MUST call a tool, but can choose which one",when:"Guarantee structured output when document type is unknown. Multiple extraction schemas.",color:"#3B82F6",code:'tool_choice={"type": "any"}  # Must use a tool'},{opt:'{"type":"tool","name":"X"}',icon:"📌",desc:"MUST call this specific named tool",when:"Force metadata extraction before enrichment. Ensure specific step happens first.",color:"#8B5CF6",code:'tool_choice={"type": "tool", "name": "extract_metadata"}'},{opt:'"none"',icon:"🚫",desc:"Cannot call any tools — text response only",when:"Tools defined but shouldn't be used for this particular turn.",color:"#EF4444",code:'tool_choice={"type": "none"}  # Text only'}].map((t,o)=>e.jsxs("div",{style:{padding:12,background:t.color+"08",borderRadius:10,border:`1px solid ${t.color}22`},children:[e.jsxs("div",{style:{display:"flex",gap:8,alignItems:"center",marginBottom:6},children:[e.jsx("span",{style:{fontSize:20},children:t.icon}),e.jsx("code",{style:{fontSize:13,fontWeight:700,color:t.color},children:t.opt})]}),e.jsx("div",{style:{fontSize:12,color:"#475569",marginBottom:4},children:t.desc}),e.jsxs("div",{style:{fontSize:11,color:"#94A3B8"},children:["Use when: ",t.when]}),e.jsx(r,{children:t.code})]},o))}),e.jsx(s,{type:"exam",children:'When "any" or forced tool is set, Claude is PREFILLED to force tool use — no natural language precedes the tool_use block. These modes are incompatible with extended thinking. Too many tools (18) degrades selection vs 4-5 focused tools. Distribute across specialized subagents.'})]}),i===3&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"MCP Server Configuration"}),e.jsx("div",{style:{display:"grid",gap:8,marginBottom:12},children:[{scope:"Project",file:".mcp.json",shared:!0,color:"#3B82F6",desc:"Shared via version control. All team members get these servers.",cmd:"claude mcp add github --scope project"},{scope:"User",file:"~/.claude.json",shared:!1,color:"#F59E0B",desc:"Personal config. NOT shared. For experimental servers.",cmd:"claude mcp add myserver --scope user"},{scope:"Local",file:".claude/settings.local.json",shared:!1,color:"#10B981",desc:"Project-specific personal. Default scope. Gitignored.",cmd:"claude mcp add myserver  # default scope"}].map((t,o)=>e.jsxs("div",{style:{padding:12,background:t.color+"08",borderRadius:10,border:`1px solid ${t.color}22`},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:4},children:[e.jsx("code",{style:{fontSize:13,fontWeight:700,color:t.color},children:t.file}),e.jsx("span",{style:{fontSize:10,padding:"2px 8px",borderRadius:4,background:t.shared?"#DCFCE7":"#FEE2E2",color:t.shared?"#166534":"#991B1B"},children:t.shared?"✓ Shared via VC":"✗ NOT shared"})]}),e.jsx("div",{style:{fontSize:12,color:"#475569"},children:t.desc}),e.jsx(r,{children:t.cmd})]},o))}),e.jsx("h4",{style:{fontSize:13,fontWeight:600,color:"#1E293B"},children:"Environment Variable Expansion"}),e.jsx(r,{children:`// .mcp.json — secrets stay OUT of version control
{
  "mcpServers": {
    "github": {
      "command": "npx",
...
// Supported in: command, args, env, url, headers`}),e.jsx("h4",{style:{fontSize:13,fontWeight:600,color:"#1E293B",marginTop:12},children:"MCP Resources vs Tools"}),e.jsx(l,{left:{title:"🔧 MCP Tools (Model-controlled)",content:e.jsx("div",{style:{fontSize:12,color:"#991B1B",lineHeight:1.5},children:"Execute actions. Claude decides when to call. Examples: create_ticket, send_email, query_db. Each call costs a tool-use turn."})},right:{title:"📚 MCP Resources (App-controlled)",content:e.jsx("div",{style:{fontSize:12,color:"#166534",lineHeight:1.5},children:"Expose read-only data. App/user selects. Examples: database schemas, doc hierarchies. Reduce exploratory tool calls (0 calls vs 3+ to discover schema)."})}}),e.jsx(s,{type:"key",children:"Prefer community MCP servers for standard integrations (GitHub, Jira, Slack, Postgres). Build custom servers only for team-specific workflows."})]}),i===4&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"Built-in Tools — Selection Guide"}),e.jsx("div",{style:{display:"grid",gap:6},children:[{tool:"Grep",purpose:"Search file CONTENTS for patterns",use:'"Find all files containing processRefund"',icon:"🔍",color:"#3B82F6"},{tool:"Glob",purpose:"Find files by NAME/EXTENSION patterns",use:'"Find all test files: **/*.test.tsx"',icon:"📂",color:"#10B981"},{tool:"Read",purpose:"Load full file contents (text, images, PDFs)",use:'"Read the contents of config.py"',icon:"📄",color:"#F59E0B"},{tool:"Edit",purpose:"Targeted find-and-replace modifications",use:'"Change MAX_RETRIES from 3 to 5"',icon:"✏️",color:"#8B5CF6"},{tool:"Write",purpose:"Create new files or full overwrite",use:'"Create a new utils.py file"',icon:"📝",color:"#EF4444"},{tool:"Bash",purpose:"Execute shell commands",use:'"Run the test suite: npm test"',icon:"💻",color:"#6366F1"}].map((t,o)=>e.jsxs("div",{style:{display:"flex",gap:10,padding:10,background:t.color+"08",borderRadius:8,border:`1px solid ${t.color}22`,alignItems:"center"},children:[e.jsx("span",{style:{fontSize:18},children:t.icon}),e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:13,fontWeight:700,color:t.color},children:t.tool}),e.jsx("div",{style:{fontSize:12,color:"#475569"},children:t.purpose}),e.jsx("div",{style:{fontSize:11,color:"#94A3B8",fontStyle:"italic"},children:t.use})]})]},o))}),e.jsx(s,{type:"key",children:"Edit failure fallback: If Edit fails (non-unique text match), fall back to Read + Write — read the full file, modify in memory, write it back. Incremental exploration: Glob (find files) → Grep (find patterns) → Read (load content). Never read all files upfront."}),e.jsx(s,{type:"exam",children:'Grep searches file CONTENTS. Glob matches file NAMES. This distinction is directly tested. "Find all callers of processRefund" → Grep. "Find all .test.tsx files" → Glob.'})]})]})}function p(){const[i,n]=c.useState(0),a=[{label:"📁 CLAUDE.md",color:"#F59E0B"},{label:"📋 Rules & Paths",color:"#8B5CF6"},{label:"⚡ Skills & Commands",color:"#3B82F6"},{label:"📐 Plan Mode",color:"#10B981"},{label:"🔄 Iterative Refinement",color:"#F97316"},{label:"🏗️ CI/CD",color:"#EF4444"}];return e.jsxs("div",{children:[e.jsx(d,{items:a,active:i,onSelect:n}),i===0&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"CLAUDE.md Configuration Hierarchy"}),e.jsx("div",{style:{fontSize:13,color:"#64748B",marginBottom:12},children:"Lower levels override higher. All levels COMBINE — more specific rules win on conflicts."}),e.jsx("div",{style:{display:"grid",gap:4},children:[{level:"1",file:"~/.claude/CLAUDE.md",scope:"User-level",shared:!1,color:"#EF4444",detail:"Personal preferences. NOT shared via VC. Only applies to YOU."},{level:"2",file:".claude/CLAUDE.md or ./CLAUDE.md",scope:"Project-level",shared:!0,color:"#3B82F6",detail:"Team standards. Shared via VC. Where coding conventions belong."},{level:"3",file:".claude/rules/*.md",scope:"Rules (optional path-scoping)",shared:!0,color:"#8B5CF6",detail:"Topic-specific files. Can load conditionally with glob patterns."},{level:"4",file:"subdir/CLAUDE.md",scope:"Directory-level",shared:!0,color:"#10B981",detail:"Highest precedence. Loaded on-demand when editing files in that dir."}].map((t,o)=>e.jsxs("div",{style:{display:"flex",gap:10,padding:10,borderRadius:8,border:`2px solid ${t.color}33`,alignItems:"center"},children:[e.jsx("div",{style:{width:28,height:28,borderRadius:8,background:t.color+"20",display:"flex",alignItems:"center",justifyContent:"center",fontSize:13,fontWeight:800,color:t.color},children:t.level}),e.jsxs("div",{style:{flex:1},children:[e.jsxs("div",{style:{display:"flex",gap:8,alignItems:"center"},children:[e.jsx("code",{style:{fontSize:12,fontWeight:600,color:t.color},children:t.file}),e.jsx("span",{style:{fontSize:10,padding:"1px 6px",borderRadius:3,background:t.shared?"#DCFCE7":"#FEE2E2",color:t.shared?"#166534":"#991B1B"},children:t.shared?"Shared":"NOT shared"})]}),e.jsx("div",{style:{fontSize:11,color:"#64748B"},children:t.detail})]}),e.jsx("div",{style:{fontSize:10,color:"#94A3B8"},children:o===0?"Lowest":o===3?"Highest":""})]},o))}),e.jsx(s,{type:"exam",children:"Exam Trap #1: New team member doesn't see conventions → they're in ~/.claude/CLAUDE.md (user-level, not shared). Fix: move to .claude/CLAUDE.md (project-level). This is directly tested."}),e.jsx(s,{type:"key",children:"@import syntax: Reference external files to keep CLAUDE.md modular. Example: @docs/api-standards.md includes that file inline. /memory command: Verify which config files are loaded and diagnose inconsistent behavior."})]}),i===1&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:".claude/rules/ — Path-Specific Conditional Loading"}),e.jsx(r,{children:`# .claude/rules/testing.md
---
...
- Functions under 30 lines`}),e.jsx(s,{type:"exam",children:`Test files spread across the codebase (Button.test.tsx next to Button.tsx). Want same testing conventions everywhere. Solution: .claude/rules/testing.md with paths: ["**/*.test.*"]. NOT directory CLAUDE.md in each folder (doesn't scale). NOT root CLAUDE.md with inference (unreliable).`}),e.jsxs(s,{type:"key",children:["Glob syntax: * (any chars except /), ** (recursive), ? (single char), [abc] (char class), ","{a,b}"," (alternatives). Patterns starting with * or ","{"," MUST be quoted in YAML."]})]}),i===2&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"Skills & Slash Commands"}),e.jsx(r,{children:`# .claude/skills/review/SKILL.md (project-scoped skill)
---
name: code-review
...
Msg 2: "Add rate limiting to API endpoints"`}].map((t,o)=>e.jsxs("div",{style:{padding:12,background:"#F8FAFC",borderRadius:10,border:"1px solid #E2E8F0"},children:[e.jsx("div",{style:{fontSize:13,fontWeight:700,color:"#1E293B",marginBottom:4},children:t.label}),e.jsx("div",{style:{fontSize:12,color:"#475569",marginBottom:6},children:t.desc}),e.jsx(r,{children:t.code})]},o))})]}),i===5&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"CI/CD Integration with Claude Code"}),e.jsx(s,{type:"exam",children:"The -p flag is the ONLY correct answer for running Claude Code in CI. CLAUDE_HEADLESS=true doesn't exist. --batch doesn't exist. stdin redirect doesn't properly address Claude Code's syntax."}),e.jsx(r,{children:`# Run non-interactively in CI
...
claude -p "Review changes" \\
  ...
  }'`}),e.jsx(s,{type:"key",children:"Session context isolation: The same Claude session that GENERATED code is biased when REVIEWING it (retained reasoning context). Use INDEPENDENT sessions — a fresh -p call for review. Include prior findings when re-running reviews to avoid duplicate PR comments."})]})]})}function m(){const[i,n]=c.useState(0),a=[{label:"🎯 Explicit Criteria",color:"#8B5CF6"},{label:"📝 Few-Shot",color:"#3B82F6"},{label:"🔧 tool_use Output",color:"#10B981"},{label:"🔄 Retry Loops",color:"#F59E0B"},{label:"📦 Batch API",color:"#EF4444"},{label:"👁️ Review Arch",color:"#6366F1"}];return e.jsxs("div",{children:[e.jsx(d,{items:a,active:i,onSelect:n}),i===0&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"Explicit Criteria Beat Vague Instructions"}),e.jsx(l,{left:{title:'❌ Vague: "Be conservative"',content:e.jsx(r,{children:`"Check that comments are accurate"
...
</example>`}),e.jsxs(s,{type:"key",children:["Few-shot examples enable GENERALIZATION to novel patterns, not just matching shown cases. They teach judgment about ambiguous situations. 2-4 examples for ambiguous cases. Wrap in ","<example>"," XML tags. Include reasoning to show WHY an action was chosen over alternatives."]}),e.jsx(s,{type:"exam",children:"Few-shot is the most effective technique when detailed instructions alone produce inconsistent results. It reduces hallucination in extraction tasks (handling informal measurements, varied document structures). Shows the model how to handle edge cases you can't enumerate."})]}),i===2&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"Structured Output via tool_use — Guarantees Syntax, Not Semantics"}),e.jsx(l,{left:{title:"✅ Syntax Errors FIXED by tool_use",content:e.jsx("div",{style:{display:"grid",gap:3},children:["Missing closing brace","Invalid JSON comma","Wrong type (string vs number)","Missing required field","Malformed array"].map((t,o)=>e.jsxs("div",{style:{fontSize:12,padding:"3px 6px",background:"#DCFCE7",borderRadius:4,color:"#166534"},children:["✓ ",t]},o))})},right:{title:"❌ Semantic Errors NOT caught",content:e.jsx("div",{style:{display:"grid",gap:3},children:["Line items don't sum to total","Values in wrong fields","Fabricated data for missing info","Inconsistent dates/amounts","Hallucinated field values"].map((t,o)=>e.jsxs("div",{style:{fontSize:12,padding:"3px 6px",background:"#FEE2E2",borderRadius:4,color:"#991B1B"},children:["✗ ",t]},o))})}}),e.jsx(r,{children:`# Force extraction with schema validation
...
data = response.content[0].input  # Guaranteed valid JSON`}),e.jsx(s,{type:"exam",children:'Make fields NULLABLE when source docs may not contain the info — prevents fabrication. Add "other" + detail string for extensible enums. Add "unclear" for ambiguous cases. strict: true eliminates ALL syntax errors via constrained decoding. Limits: max 20 strict tools, 24 optional params.'})]}),i===3&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"Validation-Retry Loops"}),e.jsx(r,{children:`# Retry-with-error-feedback pattern:
...
summarized history.`})}}),e.jsx("h4",{style:{fontSize:13,fontWeight:600,color:"#1E293B",marginTop:12},children:'"Lost in the Middle" Effect'}),e.jsxs("div",{style:{background:"#F8FAFC",borderRadius:10,padding:12,border:"1px solid #E2E8F0",marginBottom:8},children:[e.jsx("div",{style:{display:"flex",height:40,gap:1,alignItems:"flex-end"},children:[92,88,78,62,45,35,28,25,23,25,28,30,28,25,23,25,28,35,45,62,78,88,92,96].map((t,o)=>e.jsx("div",{style:{flex:1,height:`${t}%`,borderRadius:"2px 2px 0 0",background:t>70?"#22C55E":t>50?"#F59E0B":"#EF4444"}},o))}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",fontSize:10,color:"#94A3B8",marginTop:4},children:[e.jsx("span",{children:"Beginning ✅ High attention"}),e.jsx("span",{children:"Middle ❌ May miss findings"}),e.jsx("span",{children:"End ✅ High attention"})]})]}),e.jsx(s,{type:"key",children:"Mitigation: Place key findings summaries at the BEGINNING. Use explicit section headers. Put critical data in structured blocks at start or end. Trim verbose tool outputs BEFORE they enter context (e.g., keep only 5 relevant fields from 40-field order lookup)."})]}),i===1&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"Escalation Decision Framework"}),e.jsx("div",{style:{display:"grid",gap:6},children:[{trigger:'"I want to talk to a real person"',action:"Escalate IMMEDIATELY",color:"#EF4444",why:"Honor explicit request. Do NOT attempt investigation first. Compile structured handoff summary."},{trigger:"Policy gap / exception",action:"Escalate",color:"#F59E0B",why:"Policy is silent on customer's request (e.g., competitor price matching). Agent can't invent policy."},{trigger:"No progress after retries",action:"Escalate",color:"#F59E0B",why:"Inability to make meaningful progress. Don't waste customer's time."},{trigger:"Frustrated but solvable issue",action:"Acknowledge + attempt",color:"#10B981",why:'"I understand your frustration. Let me check right away." Escalate ONLY if customer reiterates preference.'},{trigger:"High sentiment / anger score",action:"DO NOT auto-escalate ❌",color:"#64748B",why:"Sentiment ≠ complexity. Angry customer may have simple issue. This is a WRONG ANSWER on the exam."},{trigger:"Low self-reported confidence",action:"DO NOT auto-escalate ❌",color:"#64748B",why:"LLM confidence is poorly calibrated. Agent incorrectly confident on hard cases, uncertain on easy ones. WRONG ANSWER."},{trigger:"Multiple customer matches",action:"Ask for identifiers",color:"#3B82F6",why:`Don't select based on heuristics. Ask: "Could you provide your account number or email?"`}].map((t,o)=>e.jsxs("div",{style:{display:"flex",gap:8,padding:8,borderRadius:6,background:t.color+"08",border:`1px solid ${t.color}22`,alignItems:"center"},children:[e.jsx("span",{style:{fontSize:11,fontWeight:700,color:t.color,minWidth:90,textAlign:"center"},children:t.action}),e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:12,fontWeight:600,color:"#334155"},children:t.trigger}),e.jsx("div",{style:{fontSize:11,color:"#64748B"},children:t.why})]})]},o))})]}),i===2&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"Error Propagation in Multi-Agent Systems"}),e.jsx(l,{left:{title:"❌ Generic Error (Hides Context)",content:e.jsx(r,{children:`# Agent returns:
{"status": "error", 
...
# extractions to detect novel error patterns`}),e.jsx(s,{type:"key",children:"Stratified random sampling: Don't just review low-confidence extractions. ALSO randomly sample high-confidence ones by document type. This catches novel error patterns that confidence scores miss. Calibrate thresholds using labeled validation sets."})]}),i===5&&e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:15,fontWeight:700,color:"#1E293B",marginBottom:8},children:"Information Provenance & Source Attribution"}),e.jsx(r,{children:`# Claim-source mappings (subagents must output these):
{
...
}`}),e.jsx(s,{type:"key",children:"Conflicting statistics: Annotate BOTH values with source attribution. Don't arbitrarily select one. Include temporal context (publication dates) — a 2020 stat vs 2024 stat isn't a contradiction, it's temporal change. Render by content type: financial data as tables, news as prose, technical findings as structured lists."}),e.jsx(s,{type:"exam",children:"Source attribution gets lost during summarization when findings are compressed without preserving claim-source mappings. Require subagents to output structured mappings that downstream agents MUST preserve through synthesis."})]})]})}function y(){const[i,n]=c.useState("d2"),a={d2:e.jsx(u,{}),d3:e.jsx(p,{}),d4:e.jsx(m,{}),d5:e.jsx(g,{})};return e.jsxs("div",{style:{fontFamily:"'Segoe UI', system-ui, sans-serif",maxWidth:780,margin:"0 auto",padding:"12px 10px"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:12},children:[e.jsx("h1",{style:{fontSize:18,fontWeight:800,color:"#1E293B",margin:0},children:"Domains 2–5: Complete Visual Learning"}),e.jsx("div",{style:{fontSize:12,color:"#64748B"},children:"Interactive diagrams, comparisons, code examples, and exam tips"})]}),e.jsx("div",{style:{display:"flex",gap:4,marginBottom:14},children:h.map(t=>e.jsx("button",{onClick:()=>n(t.id),style:{flex:1,padding:"8px 4px",borderRadius:8,fontSize:12,fontWeight:600,cursor:"pointer",border:`2px solid ${i===t.id?t.color:"#E2E8F0"}`,background:i===t.id?t.color+"15":"white",color:i===t.id?t.color:"#64748B"},children:t.label},t.id))}),e.jsx("div",{style:{background:"white",borderRadius:16,border:"1px solid #E2E8F0",padding:16},children:a[i]})]})}export{y as default};
