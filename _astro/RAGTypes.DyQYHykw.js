...
async def speculative_rag(question: str):
    ...
    return final`,general:"Good for developer support chatbots — can speculate on common errors and verify against your documentation."}],f=["Generation 1","Generation 2","Generation 3"],d=({value:n,max:s=5,color:t})=>e.jsx("div",{style:{display:"flex",gap:3},children:Array.from({length:s}).map((l,r)=>e.jsx("div",{style:{width:8,height:8,borderRadius:2,background:r<n?t:"#1e293b"}},r))}),h=({steps:n,colors:s,color:t})=>e.jsx("div",{style:{display:"flex",alignItems:"center",flexWrap:"wrap",gap:4,margin:"12px 0"},children:n.map((l,r)=>e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:4},children:[e.jsx("div",{style:{background:`${t}18`,border:`1px solid ${t}44`,borderRadius:6,padding:"4px 10px",fontSize:11,color:t,fontWeight:600,whiteSpace:"nowrap"},children:l}),r<n.length-1&&e.jsx("span",{style:{color:`${t}66`,fontSize:14},children:"→"})]},r))}),g=({code:n})=>{const[s,t]=p.useState(!1);return e.jsxs("div",{style:{background:"#020617",borderRadius:8,border:"1px solid #1e293b",overflow:"hidden",marginTop:12},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",padding:"6px 12px",background:"#0f172a",borderBottom:"1px solid #1e293b"},children:[e.jsx("span",{style:{color:"#475569",fontSize:11,fontFamily:"monospace"},children:"python"}),e.jsx("button",{onClick:()=>{navigator.clipboard?.writeText(n),t(!0),setTimeout(()=>t(!1),2e3)},style:{background:"none",border:"none",color:"#475569",cursor:"pointer",fontSize:11},children:s?"✓":"copy"})]}),e.jsx("pre",{style:{margin:0,padding:"12px",fontSize:11.5,lineHeight:1.7,color:"#94a3b8",fontFamily:"'Fira Code', monospace",overflowX:"auto"},children:n})]})};function v(){const[n,s]=p.useState(null),[t,l]=p.useState("overview"),r=c.find(i=>i.id===n),m=f.map(i=>({tier:i,color:c.find(o=>o.tier===i)?.tierColor,items:c.filter(o=>o.tier===i)}));return e.jsxs("div",{style:{minHeight:"100vh",background:"#020617",color:"#e2e8f0",fontFamily:"'DM Sans', system-ui, sans-serif",display:"flex",flexDirection:"column"},children:[e.jsxs("div",{style:{padding:"28px 32px 20px",borderBottom:"1px solid #0f172a"},children:[e.jsx("div",{style:{fontSize:11,fontWeight:700,letterSpacing:4,color:"#475569",textTransform:"uppercase",marginBottom:8},children:"Complete Taxonomy"}),e.jsx("h1",{style:{margin:0,fontSize:32,fontWeight:800,color:"#f8fafc",letterSpacing:-1},children:"Types of RAG"}),e.jsx("p",{style:{margin:"8px 0 0",color:"#64748b",fontSize:14},children:"10 architectures — from vanilla to agentic. Click any type to explore."})]}),e.jsxs("div",{style:{display:"flex",flex:1,overflow:"hidden"},children:[e.jsx("div",{style:{width:380,borderRight:"1px solid #0f172a",overflowY:"auto",padding:"20px 16px",flexShrink:0},children:m.map(({tier:i,color:o,items:u})=>e.jsxs("div",{style:{marginBottom:24},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,marginBottom:10},children:[e.jsx("div",{style:{height:1,flex:1,background:`${o}44`}}),e.jsx("span",{style:{color:o,fontSize:10,fontWeight:700,letterSpacing:3,textTransform:"uppercase"},children:i}),e.jsx("div",{style:{height:1,flex:1,background:`${o}44`}})]}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:u.map(a=>e.jsx("div",{onClick:()=>{s(a.id),l("overview")},style:{background:n===a.id?`${a.color}12`:"#0a0f1e",border:`1px solid ${n===a.id?a.color+"55":"#0f172a"}`,borderRadius:10,padding:"12px 14px",cursor:"pointer",transition:"all 0.15s"},children:e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10},children:[e.jsx("span",{style:{fontSize:20},children:a.emoji}),e.jsxs("div",{style:{flex:1},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start"},children:[e.jsx("span",{style:{color:n===a.id?a.color:"#e2e8f0",fontWeight:700,fontSize:14},children:a.name}),e.jsx("span",{style:{color:"#334155",fontSize:10},children:a.aka})]}),e.jsx("div",{style:{color:"#475569",fontSize:12,marginTop:2},children:a.tagline}),e.jsxs("div",{style:{display:"flex",gap:12,marginTop:6},children:[e.jsxs("div",{children:[e.jsx("div",{style:{color:"#334155",fontSize:9,marginBottom:2},children:"ACCURACY"}),e.jsx(d,{value:a.accuracy,color:a.color})]}),e.jsxs("div",{children:[e.jsx("div",{style:{color:"#334155",fontSize:9,marginBottom:2},children:"COMPLEXITY"}),e.jsx(d,{value:a.complexity,color:a.color})]}),e.jsxs("div",{children:[e.jsx("div",{style:{color:"#334155",fontSize:9,marginBottom:2},children:"SPEED"}),e.jsx(d,{value:a.speed,color:a.color})]})]})]})]})},a.id))})]},i))}),e.jsx("div",{style:{flex:1,overflowY:"auto"},children:r?e.jsxs("div",{style:{padding:"28px 32px",maxWidth:720},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:14,marginBottom:20},children:[e.jsx("span",{style:{fontSize:40},children:r.emoji}),e.jsxs("div",{children:[e.jsx("div",{style:{fontSize:11,fontWeight:700,letterSpacing:3,color:r.tierColor,textTransform:"uppercase"},children:r.tier}),e.jsx("h2",{style:{margin:"2px 0 0",fontSize:26,fontWeight:800,color:r.color},children:r.name}),e.jsx("div",{style:{color:"#475569",fontSize:13},children:r.aka})]})]}),e.jsx("div",{style:{display:"flex",gap:2,marginBottom:24,background:"#0a0f1e",borderRadius:8,padding:4,border:"1px solid #0f172a",width:"fit-content"},children:["overview","pipeline","code","general"].map(i=>e.jsx("button",{onClick:()=>l(i),style:{background:t===i?`${r.color}22`:"none",border:t===i?`1px solid ${r.color}44`:"1px solid transparent",color:t===i?r.color:"#475569",padding:"6px 14px",borderRadius:6,cursor:"pointer",fontSize:12,fontWeight:t===i?700:400,textTransform:"capitalize"},children:i==="general"?"🏗️ General":i.charAt(0).toUpperCase()+i.slice(1)},i))}),t==="overview"&&e.jsxs("div",{children:[e.jsx("p",{style:{color:"#94a3b8",fontSize:15,lineHeight:1.8,margin:"0 0 20px"},children:r.description}),e.jsxs("div",{style:{background:`${r.color}10`,border:`1px solid ${r.color}33`,borderRadius:10,padding:16,marginBottom:16},children:[e.jsx("div",{style:{color:r.color,fontWeight:700,fontSize:12,textTransform:"uppercase",letterSpacing:2,marginBottom:6},children:"Example"}),e.jsx("div",{style:{color:"#cbd5e1",fontSize:14,lineHeight:1.7},children:r.example})]}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:16},children:[e.jsxs("div",{style:{background:"#0a0f1e",border:"1px solid #0f172a",borderRadius:8,padding:12},children:[e.jsx("div",{style:{color:"#22c55e",fontSize:11,fontWeight:700,textTransform:"uppercase",letterSpacing:2,marginBottom:8},children:"✓ Best For"}),e.jsx("div",{style:{color:"#94a3b8",fontSize:13,lineHeight:1.8},children:r.when})]}),e.jsxs("div",{style:{background:"#0a0f1e",border:"1px solid #0f172a",borderRadius:8,padding:12},children:[e.jsx("div",{style:{color:"#f87171",fontSize:11,fontWeight:700,textTransform:"uppercase",letterSpacing:2,marginBottom:8},children:"⚠ Weaknesses"}),r.weaknesses.map((i,o)=>e.jsxs("div",{style:{color:"#94a3b8",fontSize:13,padding:"1px 0"},children:["• ",i]},o))]})]}),e.jsx("div",{style:{display:"flex",gap:24,background:"#0a0f1e",border:"1px solid #0f172a",borderRadius:8,padding:16},children:[["Accuracy",r.accuracy],["Complexity",r.complexity],["Speed",r.speed]].map(([i,o])=>e.jsxs("div",{children:[e.jsx("div",{style:{color:"#334155",fontSize:11,fontWeight:700,textTransform:"uppercase",marginBottom:6},children:i}),e.jsx(d,{value:o,color:r.color}),e.jsxs("div",{style:{color:"#475569",fontSize:11,marginTop:4},children:[o,"/5"]})]},i))})]}),t==="pipeline"&&e.jsxs("div",{children:[e.jsxs("div",{style:{color:"#64748b",fontSize:13,marginBottom:16},children:["Step-by-step data flow for ",r.name,":"]}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:10},children:r.pipeline.map((i,o)=>e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:14},children:[e.jsx("div",{style:{width:32,height:32,borderRadius:"50%",background:`${r.color}20`,border:`2px solid ${r.color}55`,display:"flex",alignItems:"center",justifyContent:"center",color:r.color,fontSize:13,fontWeight:800,flexShrink:0},children:o+1}),o<r.pipeline.length-1&&e.jsx("div",{style:{position:"absolute",width:2,height:10,background:`${r.color}33`,marginLeft:15,marginTop:32}}),e.jsxs("div",{style:{background:`${r.color}10`,border:`1px solid ${r.color}33`,borderRadius:8,padding:"10px 16px",flex:1,color:"#e2e8f0",fontSize:14,fontWeight:o===r.pipeline.length-1?700:400},children:[i,o===r.pipeline.length-1&&e.jsx("span",{style:{color:r.color},children:" ←"})]})]},o))}),e.jsxs("div",{style:{marginTop:20,background:"#0a0f1e",border:"1px solid #0f172a",borderRadius:8,padding:14},children:[e.jsx("div",{style:{color:"#475569",fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:2,marginBottom:8},children:"Quick Flow"}),e.jsx(h,{steps:r.pipeline,colors:r.pipelineColors,color:r.color})]})]}),t==="code"&&e.jsxs("div",{children:[e.jsxs("div",{style:{color:"#64748b",fontSize:13,marginBottom:4},children:["Implementation pattern for ",r.name,":"]}),e.jsx(g,{code:r.code})]}),t==="general"&&e.jsxs("div",{children:[e.jsxs("div",{style:{background:`${r.color}10`,border:`1px solid ${r.color}44`,borderLeft:`4px solid ${r.color}`,borderRadius:8,padding:16},children:[e.jsx("div",{style:{color:r.color,fontWeight:700,fontSize:12,textTransform:"uppercase",letterSpacing:2,marginBottom:8},children:"🏗️ General Relevance"}),e.jsx("div",{style:{color:"#cbd5e1",fontSize:14,lineHeight:1.8},children:r.general})]}),e.jsxs("div",{style:{marginTop:20,background:"#0a0f1e",border:"1px solid #0f172a",borderRadius:10,padding:16},children:[e.jsx("div",{style:{color:"#475569",fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:2,marginBottom:12},children:"Which RAG types does a general production system use?"}),[{type:"Advanced RAG",role:"Core pipeline — HyDE + Hybrid + Rerank",active:!0},{type:"Modular RAG",role:"Customer chatbot vs Developer chatbot = separate modules",active:!0},{type:"Agentic RAG",role:"Developer support chatbot — multi-hop error reasoning",active:!0},{type:"RAG Fusion",role:"Customer chatbot — handles ambiguous insurance queries",active:r.id==="ragfusion"},{type:"Multi-modal RAG",role:"Future: insurance PDF forms with tables/images",active:!1},{type:"Graph RAG",role:"Future: policy entity relationship graph",active:!1}].map((i,o)=>e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,padding:"6px 0",borderBottom:"1px solid #0f172a"},children:[e.jsx("span",{style:{fontSize:14},children:i.active?"✅":"🔮"}),e.jsxs("div",{children:[e.jsx("span",{style:{color:i.active?"#e2e8f0":"#334155",fontSize:13,fontWeight:600},children:i.type}),e.jsxs("span",{style:{color:"#475569",fontSize:12},children:[" — ",i.role]})]})]},o))]})]})]}):e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",height:"100%",gap:12,padding:40},children:[e.jsx("div",{style:{fontSize:48},children:"👈"}),e.jsxs("div",{style:{color:"#334155",fontSize:16,textAlign:"center"},children:["Select a RAG type to see",e.jsx("br",{}),"architecture, pipeline, code & general context"]}),e.jsx("div",{style:{marginTop:24,display:"flex",flexWrap:"wrap",gap:8,justifyContent:"center",maxWidth:500},children:c.map(i=>e.jsxs("div",{onClick:()=>s(i.id),style:{background:`${i.color}15`,border:`1px solid ${i.color}33`,color:i.color,borderRadius:20,padding:"4px 12px",fontSize:12,cursor:"pointer",fontWeight:600},children:[i.emoji," ",i.name]},i.id))})]})})]})]})}export{v as default};
